...
public class DelBusinessRequest extends FlRequestBase {

	public String modifyEmp;
	public String sid;

	public DelBusinessRequest(DataCollection dataSource) {
		super(dataSource);
	}
	...
	protected JSONObject getCommandInfo() {
		...
		try {
			holder.put("modifyEmp", Integer.parseInt(modifyEmp));
			holder.put("sid", sid);
