...
package com.cars.manager.networks;
...
public class AsyncHttpClient {
	...
	protected RequestHandle sendRequest(DefaultHttpClient client,
		...
		if (contentType != null) {
			...
			// uriRequest.setHeader("Basic", "flsyjh:flSYjhx2012");
		}
		// uriRequest.setHeader("Basic", "flsyjh:flSYjhx2012");
	...
	private static class InflatingEntity extends HttpEntityWrapper {
		...
		public InputStream getContent() throws IOException {
			PushbackInputStream content = new PushbackInputStream(
					wrappedEntity.getContent(), 2);
