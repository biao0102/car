...
package com.cars.manager.views.widgts.supertoast;
...
import com.cars.manager.views.widgts.supertoast.SuperToast.Animations;
import com.cars.manager.views.widgts.supertoast.SuperToast.IconPosition;
import com.cars.manager.views.widgts.supertoast.SuperToast.Type;
...
public class SuperCardToast {
	 ...
	 *            {@link android.app.Activity}
	 * @param type
	 *            {@link com.github.johnpersano.supertoasts.SuperToast.Type}
	 */
	@SuppressWarnings("ConstantConditions")
	...
	/**
	 * Returns the {@link com.github.johnpersano.supertoasts.SuperToast.Type} of
	 * {@value #TAG}.
	 * 
	...
	private void dismissWithLayoutAnimation() {
		...
		if (mToastView != null) {
			...
			ValueAnimator animator = ValueAnimator.ofInt(originalHeight, 1).setDuration(
					mActivity.getResources().getInteger(android.R.integer.config_shortAnimTime));
	...
	private Animation getShowAnimation() {
		...
		if (this.getAnimations() == Animations.FLYIN) {
			...
			TranslateAnimation translateAnimation = new TranslateAnimation(Animation.RELATIVE_TO_SELF, 0.75f, Animation.RELATIVE_TO_SELF, 0.0f,
	...
	private Animation getDismissAnimation() {
		...
		if (this.getAnimations() == Animations.FLYIN) {
			...
			TranslateAnimation translateAnimation = new TranslateAnimation(Animation.RELATIVE_TO_SELF, 0.0f, Animation.RELATIVE_TO_SELF, .75f,
					Animation.RELATIVE_TO_SELF, 0.0f, Animation.RELATIVE_TO_SELF, 0.0f);
	 ...
	 *            The current activity
	 * @param wrappers
	 *            {@link com.github.johnpersano.supertoasts.util.Wrappers}
	 */
