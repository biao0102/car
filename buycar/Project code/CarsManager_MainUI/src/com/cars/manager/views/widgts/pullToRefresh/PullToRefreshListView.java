...
public class PullToRefreshListView extends PullToRefreshAdapterViewBase<ListView> {
	...
	public void setHeaderLoadingRefreshImg(Drawable aLoadingDrawable) {
		mHeaderLoadingView.setLoadingDrawable(aLoadingDrawable);
	}

	public void setHeaderImageVisible(boolean isVisible) {
		mHeaderLoadingView.setHeaderImgVisible(isVisible);
	}
