...
public class SuperToast {
	...
	public static class Duration {
		public static final int VERY_VERY_SHORT = (500);
	...
	private int mDuration = Duration.VERY_VERY_SHORT;
	...
	public void setText(CharSequence text) {
		mMessageTextView.setText(Html.fromHtml(text.toString()));
	}
	...
	public static void show(String msg, Context aContext) {
		if (msg != null && msg.length() > 0) {
			SuperToast aSuperToast = SuperToast.create(aContext, msg, Duration.VERY_VERY_SHORT, Animations.FLYIN);
			aSuperToast.setBackground(SuperToast.Background.BLACK);
			aSuperToast.show();
		}
	}
