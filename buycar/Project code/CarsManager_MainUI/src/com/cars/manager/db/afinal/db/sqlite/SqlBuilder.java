 ...
 */
package com.cars.manager.db.afinal.db.sqlite;
...
public class SqlBuilder
{
	...
	public static SqlInfo getUpdateSqlAsSqlInfo(Object entity, String strWhere)
	{
		...
		if (keyValueList == null || keyValueList.size() == 0)
		{
			throw new DbException("this entity[" + entity.getClass() + "] has no property" + strWhere);
		}
	...
	private static KeyValue property2KeyValue(Property property, Object entity)
	{
		...
		{
			if (property.getDefaultValue() != null && property.getDefaultValue().trim().length() != 0) kv = new KeyValue(pcolumn,
