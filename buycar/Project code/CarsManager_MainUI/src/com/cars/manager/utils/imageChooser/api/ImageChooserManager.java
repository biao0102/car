...
import com.cars.manager.utils.imageChooser.threads.ImageProcessorListener;
import com.cars.manager.utils.imageChooser.threads.ImageProcessorThread;
...
public class ImageChooserManager extends BChooser implements ImageProcessorListener {
	 ...
	 * @param shouldCreateThumbnails
	 */
	public ImageChooserManager(Activity activity, int type, String foldername, boolean shouldCreateThumbnails) {
		super(activity, type, foldername, shouldCreateThumbnails);
	}

	public ImageChooserManager(Fragment fragment, int type, String foldername, boolean shouldCreateThumbnails) {
		super(fragment, type, foldername, shouldCreateThumbnails);
	}

	public ImageChooserManager(android.app.Fragment fragment, int type, String foldername, boolean shouldCreateThumbnails) {
		super(fragment, type, foldername, shouldCreateThumbnails);
	}
	...
	private String takePicture() throws Exception {
		...
		try {
			...
			filePathOriginal = FileUtils.getDirectory(foldername) + File.separator + Calendar.getInstance().getTimeInMillis() + ".jpg";
